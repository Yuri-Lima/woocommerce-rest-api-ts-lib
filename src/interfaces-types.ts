...
export declare type WooRestApiCredentials = {
...
export declare type IWooRestApiHeaders = {
  Accept: string;
  "Content-Type"?: string;
  "User-Agent"?: string;
...
export interface IWooRestApiOptions extends WooRestApiCredentials {
