...
describe("#requests", () => {
    ...
    test("should return content for basic auth", () => {
        expect.assertions(1);
        (0, nock_1.default)(`https://test.dev/wp-json/wc/v3`).post("/orders", {}).reply(201, {
            ok: true,
        });
    ...
    test("should return content for get requests", () => {
        expect.assertions(1);
        (0, nock_1.default)("https://test.dev/wp-json/wc/v3").get("/orders").reply(200, {
            ok: true,
        });
    ...
    test("should return content for put requests", () => {
        expect.assertions(1);
        (0, nock_1.default)("https://test.dev/wp-json/wc/v3").put("/orders").reply(200, {
            ok: true,
        });
    ...
    test("should return content for delete requests", () => {
        expect.assertions(1);
        (0, nock_1.default)("https://test.dev/wp-json/wc/v3").delete("/orders").reply(200, {
            ok: true,
        });
